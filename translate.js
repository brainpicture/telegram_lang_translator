...
const OPENAI_API_KEY = "PUT YOU OPENAI API KEY HERE";

async function askChatGPT(messages, model = "gpt-4-1106-preview") {
  const headers = {
...
async function scanDirectory() {
  ...
  let promises = files.filter(file => file.endsWith(".xml")).map(async file => {
